...
colors_rgb = [
    (220, 240, 255), (214, 226, 255), (181, 201, 255), (142, 178, 255),
...
# n_levels = 20  # Adjust based on your original custom colormap
...
ds_era5 = xr.open_dataset(f'{era5_path}msl_wind_kiel_v6.nc') # Consecutive events
...
time_swot1 = '2023-04-02 00:00:00'
time_short1 = 20230402

u101 = u101.sel(time = time_swot1)
v101 = v101.sel(time = time_swot1)
msl1 = msl1.sel(time = time_swot1)
...
ds_swot_kiel1 = xr.open_dataset(f'{SWOT_path}SWOT_data/SWOT_L3_LR_SSH_Expert_478_003_20230401T230647_20230401T235752_v1.0.nc') # 4th extreme event
...
ds_era5 = xr.open_dataset(f'{era5_path}msl_wind_kiel_030523_070523.nc') # 2nd extreme event
...
# Select speciphic date
time_swot2 = '2023-05-05 18:00:00' 
...
ds_swot_kiel2 = xr.open_dataset(f'{SWOT_path}SWOT_data/SWOT_L3_LR_SSH_Expert_512_003_20230505T174816_20230505T183921_v1.0.nc') # 2nd extreme event
...
# Determine to which percentile corresponds the maximum and minimum values of swot data compared to the tide gauge serie
# Create a histogram of the percentiles of df_tg_k['detided']
percentiles = np.percentile(df_tg_k['detided'], np.arange(0, 101, 1))

fig_hist, ax_hist = plt.subplots(figsize=(10, 6))
ax_hist.hist(percentiles, bins=100, edgecolor='black', alpha=0.7)
ax_hist.set_title('Histogram of Percentiles of Detided Sea Level')
ax_hist.set_xlabel('Percentile')
...
ax0.scatter(df_kiel_max['time'].iloc[3], df_kiel_max['ssha_demean'].iloc[3], marker='*', c='green', zorder=3, s=600, label=time_swot1)
ax0.scatter(df_kiel_max['time'].iloc[4], df_kiel_max['ssha_demean'].iloc[4], marker='s', c='green', zorder=3, s=240, label=time_swot2)
...
ax0.set_title('KIEL TG', fontsize=18)
...
gl4.xlabel_style = {'size': 18}  # Change the y-axis label font size
...
gl5.xlabel_style = {'size': 18}  # Change the y-axis label font size
...
gl6.xlabel_style = {'size': 18}  # Change the y-axis label font size
...
# plt.tight_layout()
plt.subplots_adjust(left=0.1, right=0.95, top=0.95, bottom=0.05, wspace=0.05, hspace=-0.23)
plt.show()